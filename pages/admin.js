...
export default function Admin() {
  ...
  const PERMISSION_GROUPS = [
    { title: "Portal (acesso aos módulos)", keys: ["organizador", "cronograma", "treinamentos", "admin", "eventos"] },
    ...
    { title: "Treinamentos", keys: ["treinamentos_view", "treinamentos_upload", "treinamentos_edit", "treinamentos_delete"] },
    { title: "Eventos", keys: ["eventos_view", "eventos_upload", "eventos_edit", "eventos_delete"] },
  ];
